...
describe("Character", function () {
  ...
  describe("constructor()", function () {
    let conChar = new Character(
      buildBlankCharObj({ name: "constructor char" })
    );
    let conChar2 = new Character(
      buildDefaultCharObj({ name: "constructor char2" })
    );
  ...
  describe("unequip(appendage)", function () {
    ...
    let unequipChar2 = new Character(
      buildDefaultCharObj({
        name: "unequip char2",
        equipped: {
          hand: item1,
    ...
    let unequipChar3 = new Character(
      buildDefaultCharObj({
        name: "unequip char3",
        equipped: {
          hand: {
  ...
  describe("modifyStat()", function () {
    let modStatChar = new Character(
      buildDefaultCharObj({ name: "modifyStat char" })
    );
  ...
  describe("updateActiveStats()", function () {
    let upActStatChar = new Character(
      buildDefaultCharObj({ name: "updateActiveStats char" })
    );
    ...
    it("should update activeStats with stats learned from guilds", function () {
      let upActStatChar2 = new Character(
        buildDefaultCharObj({
    ...
    it("if stats are too low equip items, should unequip items", function () {
      ...
      let upActStatChar3 = new Character(
        buildDefaultCharObj({
    ...
    it("should update activeStats with modifiers from equipped items", function () {
      let upActStatChar4 = new Character(
        buildDefaultCharObj({
